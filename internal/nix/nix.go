...
// LibcProfilePath contains the nix profile generated by installing packages for
// libc-dynamic-linking compatibility
const LibcProfilePath = ".devbox/nix/libc/profile/default"
