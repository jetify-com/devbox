...
const sidebars = {
    ...
    tutorialSidebar: [{
        ...
        type: 'category',
        label: 'Using Devbox with Jetify Cloud',
        link: { type: 'doc', id: 'jetify_cloud/index' },
        collapsed: true,
            items: [
            {
                type: 'doc',
                label: "Introduction to Jetify Cloud",
                id: 'jetify_cloud/index'
                ...
                items: [{
                    type: 'autogenerated',
                    dirName: 'jetify_cloud/dashboard'
                }]
            },{
                type: 'category',
