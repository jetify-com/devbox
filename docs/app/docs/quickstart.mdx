...
3. You can add a package to your project by running `devbox add <package>`. If you want to install a specific version of a package, you can run `devbox add <package>@<version>`. For example, to install Python 3.10, you can run:
